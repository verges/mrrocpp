...
void servo_buffer::load_hardware_interface(void)
{
	...
	hi =
			new hi_moxa::HI_moxa(master, mrrocpp::lib::irp6p_tfg::LAST_MOXA_PORT_NUM, ports_vector, mrrocpp::lib::irp6p_tfg::CARD_ADDRESSES, mrrocpp::lib::irp6p_tfg::MAX_INCREMENT);
	hi->init();
